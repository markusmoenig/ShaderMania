...
<img src="/ShaderMania/img/screenshots/screen.png" alt="ShaderMania editor" className={styles.heroScreenshot} />
...
<div className={styles.storeLinks}>
  <a href="https://apps.apple.com/us/app/shadermania/id1541065830" className={styles.storeBadge}>
    <img src="/ShaderMania/img/appstore.svg" alt="Download on the App Store" />
  </a>
</div>
